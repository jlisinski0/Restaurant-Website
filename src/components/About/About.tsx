...
export default function About() {
	return (
		<section className='flex justify-center items-center min-h-[40vh] w-full bg-whiteTwo  border border-snowWhite' id='Onas'>
			<div className='flex justify-center items-center flex-col py-20 '>
				...
				<div className='h-full mx-10 pt-10 lg:pt-15'>
